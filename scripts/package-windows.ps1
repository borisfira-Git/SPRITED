...
foreach($name in @('CHECKPOINT.md','AUDIT-AND-PLAN.md','CHANGELOG.md','CONNECTIONS-SETUP.md','SHELL-REDESIGN.md','VERSION')) { Copy-Item -LiteralPath (Join-Path $sourceRoot $name) -Destination $releaseRoot }
