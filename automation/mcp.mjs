...
export const MCP_INSTRUCTIONS='SPRITED turns character references and generated PNG/WebP SpriteSheets into ordered, validated game animation. Use prepare_animation_prompt first, let ChatGPT generate or inspect the image, then analyze_spritesheet, repair only reported frames, and export when quality is GOOD_ENOUGH or EXCELLENT. Never request local paths, credentials, or secrets.';
