...
test('validator carries pose-plan provenance while reporting deterministic confidence',()=>{const result=validateAnimation(valid(),{pose_plan:{version:1}});assert.equal(result.pose_plan_version,1);assert.equal(result.confidence_label,'medium');});
