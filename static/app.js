(() => {
  ...
  async function workflowAction(action,args){
    ...
    if(action==='workflow/animation/record-preflight'){r.preflight=structuredClone(args.preflight);r.updated_at=new Date().toISOString();return result(r.preflight);}
